...
function EmailVerifyComponent({ registerLanguage, handleBack, handleNext, activeStep }:{ registerLanguage: object, handleBack: void, handleNext: void, activeStep: number}) {
    return (
